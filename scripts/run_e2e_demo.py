...
Usage:
    python scripts/run_e2e_demo.py                  # auto-generated policy
    python scripts/run_e2e_demo.py --model mixtral   # Mixtral 4-bit
    python scripts/run_e2e_demo.py --policy my.moe   # user-written policy
"""
